...
type ListsPostsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ListsPostsRequest) Reset() {
	*x = ListsPostsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListsPostsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListsPostsRequest) ProtoMessage() {}

func (x *ListsPostsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protos_v1_post_post_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListsPostsRequest.ProtoReflect.Descriptor instead.
func (*ListsPostsRequest) Descriptor() ([]byte, []int) {
...
var file_protos_v1_post_post_proto_rawDesc = []byte{
	...
	0x13, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x52, 0x65, 0x71,
	...
	0x61, 0x67, 0x65, 0x73, 0x32, 0xa7, 0x01, 0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x5a, 0x0a,
	...
	,
...
var file_protos_v1_post_post_proto_goTypes = []interface{}{
	...
	(*ListsPostsRequest)(nil),         // 3: v1.post.ListsPostsRequest
...
var file_protos_v1_post_post_proto_depIdxs = []int32{
	...
	3, // 3: v1.post.Post.ListPosts:input_type -> v1.post.ListsPostsRequest
...
func file_protos_v1_post_post_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_v1_post_post_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListsPostsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
